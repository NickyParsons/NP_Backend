...
namespace TestAspNetApplication.Migrations
{
    ...
    [Migration("20241029145853_ArticleNullUpdateTime")]
    partial class ArticleNullUpdateTime
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TestAspNetApplication.Data.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("59cd2ea8-ec7c-4a16-b469-23bc0f1ffe81"),
                            Description = "Администратор",
                            Name = "Admin"
                        },
                        new
                        {
                            Id = new Guid("44abda67-2753-4dd0-a5c2-9559314b556a"),
            ...
            modelBuilder.Entity("TestAspNetApplication.Data.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("714e4522-ce6c-4472-9a2c-0c8363bc3cb0"),
                            Email = "admin@admin",
                            HashedPassword = "ClS/8E1JPP39gGPmRyBl+w==;9eoVht2Ofj0+SGFPWBL/WivJKHjT1ffYFPD4dj90WJE=",
                            RoleId = new Guid("59cd2ea8-ec7c-4a16-b469-23bc0f1ffe81")
                        });
                });
